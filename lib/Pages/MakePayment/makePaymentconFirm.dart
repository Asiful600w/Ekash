...
import 'package:thesis/Pages/MakePayment/makePaymentInfo.dart';
...
class makePaymentConfirmScreen extends StatefulWidget {
  final String number;
  final String amount;
  const makePaymentConfirmScreen({
    super.key,
  ...
  @override
  State<makePaymentConfirmScreen> createState() =>
      _makePaymentConfirmScreenState();
}

class _makePaymentConfirmScreenState extends State<makePaymentConfirmScreen>
                ...
                Container(
                  ...
                  child: LayoutBuilder(
                    builder: (context, constraints) {
                      final baseFontSize = constraints.maxHeight * 0.05;
                  ...
                  IconButton(
                    ...
                    onPressed: () async {
                      try {
                        ...
                        await _audioPlayer
                            .setAsset('Assets/Audio/Payment2ndpage.mp3');
                    ...
                    onPressed: () {
                      showDialog(
                        ...
                        builder: (context) => const VideoHelpPopup(
                          videoAssetPath: 'Assets/Videos/Payment2.mp4',
                        ),
                      );
                ...
                onPressed: () async {
                  ...
                  _holdTimer = Timer(const Duration(seconds: 3), () async {
                    try {
                      ...
                      Get.offAll(makePaymentDetailPage(
                      ...
                      Get.snackbar('error'.tr, 'makePaymetFail'.tr);
                    }
                  });
                },
              ),
