...
class cashOutDetailPage extends StatefulWidget {
  ...
  @override
  State<cashOutDetailPage> createState() => _cashOutDetailPageState();
}

class _cashOutDetailPageState extends State<cashOutDetailPage> {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('cashOutSuccessful'.tr)),
        );
      }
    });
  }
  ...
  Future<void> _playSuccessSound() async {
    try {
      await _audioPlayer.setAsset('Assets/Audio/cashoutconfirmhelp.mp3');
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildDetailRow('cashOutAmount'.tr,
