...
import 'cashOutConfirmScreen.dart';
...
// Add these audio assets to your list
  ...
  final List<String> _audioInstructions = [
    'Assets/Audio/cashouthelp1.mp3',
    'Assets/Audio/cashouthelp2.mp3',
    'Assets/Audio/sendmoneyhelp3.mp3',
  ];
  //Guide System
  void _startGuide() async {
    final hasValidAgentNumber = UserController.cashOutNum.text.length == 11;
    setState(() {
      _isGuidedMode = true;
      ...
      if (hasValidAgentNumber) {
        ...
        WidgetsBinding.instance.addPostFrameCallback((_) {
          FocusScope.of(context)
              .requestFocus(UserController.cashOutAmountFocus);
        });
      } else {
        _qrButtonController.repeat(reverse: true);
        // Focus number field if starting at step 0
        WidgetsBinding.instance.addPostFrameCallback((_) {
          FocusScope.of(context).requestFocus(UserController.cashOutNumFocus);
        });
      }
    });
    ...
    try {
      ...
      if (phoneNumber != null) {
        ...
        if (cleanedNumber.startsWith('01') && cleanedNumber.length == 11) {
          UserController.cashOutNum.text = cleanedNumber;
        } else {
  ...
  void dispose() {
    ...
    UserController.cashOutNumFocus.dispose();
    UserController.cashOutAmountFocus.dispose();
    _audioPlayer.stop();
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: textFieldWidgets2(
                      ...
                      focusNode: UserController.cashOutNumFocus,
                      hintText: 'agentNumber'.tr,
                      controller: UserController.cashOutNum,
                      ...
                      onPressed: () async {
                        ...
                        if (scannedResult != null && scannedResult is String) {
                          ...
                          if (extractedNumber != null) {
                            setState(() {
                              UserController.cashOutNum.text = extractedNumber;
                            });
                          } else {
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: textFieldWidgets2(
                      ...
                      hintText: 'amount'.tr,
                      controller: UserController.cashOutAmount,
                      inputType: TextInputType.number,
                      iconPath: "Assets/Icons/money2.svg",
                      obscure: false,
                      focusNode: UserController.cashOutAmountFocus,
                    ),
                  ),
                ),
                    ...
                    child: Stack(
                      ...
                      children: [
                        IconButton(
                          ...
                          onPressed: () {
                            final number = UserController.cashOutNum.text;
                            final amount = UserController.cashOutAmount.text;

                            if (number.isEmpty) {
                              Get.snackbar('error'.tr, 'enterAgentNumber'.tr,
                                  backgroundColor: Colors.red[200]);
                              return;
                            }
                  ...
                  IconButton(
                    ...
                    onPressed: () async {
                      try {
                        ...
                        await _audioPlayer
                            .setAsset('Assets/Audio/Cashout1stpage.mp3');
                        await _audioPlayer.play();
                        _audioPlayer.playerStateStream.listen((state) {
                    ...
                    onPressed: () {
                      showDialog(
                        ...
                        builder: (context) => const VideoHelpPopup(
                          videoAssetPath: 'Assets/Videos/CashOut1.mp4',
                        ),
                      );
                          ...
                          content: SingleChildScrollView(
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  _buildHelpSection(
                                      imagePath: 'Assets/Images/cashout1.png',
                                      title: 'Cashoutpage1step1title'.tr,
                                      text: 'Cashoutpage1step1Text'.tr),
                                  const SizedBox(height: 15),
                                  _buildHelpSection(
                                      imagePath:
                                          'Assets/Images/sendMoneyHelp2.png',
                                      title: 'step2Title'.tr,
                                      text: 'Cashoutpage1step2Text'.tr),
                                  const SizedBox(height: 15),
                                  _buildHelpSection(
                                      imagePath:
