...
class cashOutConfirmScreen extends StatefulWidget {
  final String number;
  final String amount;
  ...
  @override
  State<cashOutConfirmScreen> createState() => _cashOutConfirmScreenState();
}

class _cashOutConfirmScreenState extends State<cashOutConfirmScreen>
                  ...
                  IconButton(
                    ...
                    onPressed: () async {
                      try {
                        ...
                        await _audioPlayer
                            .setAsset('Assets/Audio/Cashout2ndpage.mp3');
                    ...
                    onPressed: () {
                      showDialog(
                        ...
                        builder: (context) => const VideoHelpPopup(
                          videoAssetPath: 'Assets/Videos/CashOut2.mp4',
                        ),
                      );
                ...
                onPressed: () async {
                  ...
                  _holdTimer = Timer(const Duration(seconds: 3), () async {
                    try {
                      ...
                      Get.snackbar('error'.tr, 'cashOutFail'.tr);
                    }
                  });
                },
              ),
